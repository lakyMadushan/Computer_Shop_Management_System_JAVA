...
public class Profit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        date_select = new javax.swing.JButton();
        calculate_profit = new javax.swing.JButton();
        rupee = new javax.swing.JLabel();
        rupee1 = new javax.swing.JLabel();
        rupee2 = new javax.swing.JLabel();
        ...
        jPanel1.add(print_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 745, 190, 50));
        ...
        add_profit_btn.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 204, 0), 8));
        ...
        jPanel1.add(back_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 745, 190, 50));
        ...
        date_search1_txt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                date_search1_txtActionPerformed(evt);
            }
        });
        ...
        calander.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2));
        calander.setForeground(new java.awt.Color(102, 102, 102));
        calander.setDateFormatString("yyyy/MM/dd");
        calander.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        calander.setMaxSelectableDate(new java.util.Date(253370748704000L));
        calander.setMinSelectableDate(new java.util.Date(-62135785696000L));
        calander.setOpaque(false);
        calander.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                calanderMouseClicked(evt);
            }
        });
        jPanel1.add(calander, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 170, 280, 40));

        date_select.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        date_select.setForeground(new java.awt.Color(255, 255, 255));
        date_select.setText("Press");
        date_select.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2));
        date_select.setContentAreaFilled(false);
        date_select.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        date_select.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                date_selectActionPerformed(evt);
            }
        });
        jPanel1.add(date_select, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 180, 80, 30));

        calculate_profit.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        calculate_profit.setForeground(new java.awt.Color(255, 255, 255));
        calculate_profit.setText("Calculation");
        calculate_profit.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2));
        calculate_profit.setContentAreaFilled(false);
        calculate_profit.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        calculate_profit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                calculate_profitActionPerformed(evt);
            }
        });
        jPanel1.add(calculate_profit, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 120, 80, 30));

        rupee.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        rupee.setForeground(new java.awt.Color(255, 255, 255));
        rupee.setText("Rs.");
        jPanel1.add(rupee, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 90, 60, 40));

        rupee1.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        rupee1.setForeground(new java.awt.Color(255, 255, 255));
        rupee1.setText("Rs.");
        jPanel1.add(rupee1, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 170, 40, 40));

        rupee2.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        rupee2.setForeground(new java.awt.Color(255, 255, 255));
        rupee2.setText("Rs.");
        jPanel1.add(rupee2, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 250, 30, 40));
    ...
    private void add_profit_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_profit_btnActionPerformed
        ...
        try {
            ...
            Date dob = calander.getDate();
            
            //String time = date_search1_txt.getText();
           
            dbcon.IUD("INSERT INTO profit (`income`,`cost`,`profit`,`time`) VALUES ('"+income+"','"+cost+"','"+profit+"','"+dob+"')");
    ...
    private void calanderMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_calanderMouseClicked
        // TODO add your handling code here:
        
       
    }//GEN-LAST:event_calanderMouseClicked

    private void date_search1_txtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_date_search1_txtActionPerformed
        // TODO add your handling code here:
        
    }//GEN-LAST:event_date_search1_txtActionPerformed

    private void date_selectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_date_selectActionPerformed
        // TODO add your handling code here:
        Date dob = calander.getDate();
        date_search1_txt.setText(dob.toString());
    }//GEN-LAST:event_date_selectActionPerformed
    ...
    private javax.swing.JButton date_select;
    ...
    private javax.swing.JLabel rupee1;
    private javax.swing.JLabel rupee2;
