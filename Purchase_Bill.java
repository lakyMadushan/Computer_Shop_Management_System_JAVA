...
public class Purchase_Bill extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        loadAll2 = new javax.swing.JButton();
        ...
        jPanel1.add(back_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 725, 160, 50));
        ...
        loadAll2.setBackground(new java.awt.Color(255, 255, 255));
        loadAll2.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        loadAll2.setForeground(new java.awt.Color(255, 255, 255));
        loadAll2.setText("ALL");
        loadAll2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2));
        loadAll2.setContentAreaFilled(false);
        loadAll2.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        loadAll2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                loadAll2ActionPerformed(evt);
            }
        });
        jPanel1.add(loadAll2, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 140, 50, 40));
    ...
    private void loadAll2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadAll2ActionPerformed
        // TODO add your handling code here:
        DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
        dtm.setRowCount(0);
        try {
    ...
    }//GEN-LAST:event_loadAll2ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Purchase_Bill().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton loadAll2;
