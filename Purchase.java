...
public class Purchase extends javax.swing.JFrame {
    ...
    public Purchase() {
        ...
        try {
            ...
            ResultSet rs = dbcon.SEARCH("SELECT * FROM purchase");
            while(rs.next()){
    ...
    private void initComponents() {
        ...
        jPanel1.add(print_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 725, 160, 50));

        jLabel2.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("------ PURCHASE -------");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 20, -1, -1));
        ...
        jPanel1.add(remove_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 190, 170, 50));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "DATE", "BILL NO.", "DISTRIBUTER", "BRAND", "MODEL", "ITEM CODE", "QTY", "BUY", "SELL", "TOTAL"
            }
        ));
        ...
        jPanel1.add(back_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 725, 170, 50));
        ...
        jPanel1.add(distri_combo, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 142, 370, 40));

        jLabel6.setFont(new java.awt.Font("Arial", 1, 36)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("LAKY_COMPUTER SHOP");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 20, -1, -1));
        ...
        jPanel1.add(loadAll, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 140, 50, 40));
        ...
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 780, 620, -1));
    ...
    private void remove_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_remove_btnActionPerformed
        ...
        try {
            ...
            dbcon.IUD("DELETE FROM purchase WHERE `id` = '"+delr+"' ");
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.removeRow(r);
    ...
    private void edit_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_edit_btnActionPerformed
        // TODO add your handling code here:
         try {
            ...
            String total = jTable1.getValueAt(r, 10).toString();
            
            dbcon.IUD("UPDATE purchase SET `date` = '"+date+"' WHERE `id` = '"+id+"' ");
            dbcon.IUD("UPDATE purchase SET `bill_no` = '"+bill_no+"' WHERE `id` = '"+id+"' ");
            dbcon.IUD("UPDATE purchase SET `distributor` = '"+distributor+"' WHERE `id` = '"+id+"' ");
            dbcon.IUD("UPDATE purchase SET `brand` = '"+brand+"' WHERE `id` = '"+id+"' ");
            dbcon.IUD("UPDATE purchase SET `model` = '"+model+"' WHERE `id` = '"+id+"' ");
            dbcon.IUD("UPDATE purchase SET `item_code` = '"+item_code+"' WHERE `id` = '"+id+"' ");
            dbcon.IUD("UPDATE purchase SET `qty` = '"+qty+"' WHERE `id` = '"+id+"' ");
            dbcon.IUD("UPDATE purchase SET `buy` = '"+buy+"' WHERE `id` = '"+id+"' ");
            dbcon.IUD("UPDATE purchase SET `sell` = '"+sell+"' WHERE `id` = '"+id+"' ");
            dbcon.IUD("UPDATE purchase SET `total` = '"+total+"' WHERE `id` = '"+id+"' ");
    ...
    private void distri_comboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_distri_comboActionPerformed
        ...
        try {
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            ResultSet rs = dbcon.SEARCH("SELECT * FROM purchase WHERE `distributor` = '"+String.valueOf(distri_combo.getSelectedItem())+"'");
            while(rs.next()){
                String id = rs.getString("id");
                String date = rs.getString("date");
