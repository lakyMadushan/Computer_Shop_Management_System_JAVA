...
public class Register extends javax.swing.JFrame implements Runnable{
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 750, -1, -1));
        ...
        show.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        show.setForeground(new java.awt.Color(0, 153, 0));
        show.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jPanel1.add(show, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 630, 290, 40));

        serialKey_txt.setBackground(javax.swing.UIManager.getDefaults().getColor("Button.background"));
        serialKey_txt.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        ...
        jPanel1.add(serialKey_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 500, 364, 40));

        register_btn.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        ...
        jPanel1.add(register_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 690, 180, 60));
        ...
        jPanel1.add(img_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 680, 200, 50));

        jLabel10.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(0, 0, 0));
        jLabel10.setText("PASSWORD");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 580, -1, -1));

        back_btn1.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        back_btn1.setForeground(new java.awt.Color(0, 0, 0));
        back_btn1.setText("LOGOUT");
        ...
        jPanel1.add(back_btn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 690, 170, 60));

        user_txt.setBackground(javax.swing.UIManager.getDefaults().getColor("Button.background"));
        user_txt.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        ...
        name_txt.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        ...
        contact_txt.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        ...
        address_txt.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        ...
        jPanel1.add(password_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 570, 364, 40));
        ...
        calander.setBackground(new java.awt.Color(255, 255, 255));
        calander.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        calander.setForeground(new java.awt.Color(255, 255, 255));
        calander.setDateFormatString("yyyy/MM/dd");
        calander.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        calander.setOpaque(false);
        jPanel1.add(calander, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 430, 360, 40));

        jLabel11.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(0, 0, 0));
        jLabel11.setText("SERIAL KEY");
    ...
    private void register_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_register_btnActionPerformed
        ...
        try {
          ...
          // String dob = calander.getDateFormatString();
...
//           InputStream is = new FileInputStream(new File(parth2));
           ...
           if(serialKey_txt.getText().equals("1")){
            //.showMessageDialog(this,"You are Owner!","ADMIN",JOptionPane.INFORMATION_MESSAGE);
            
            String b = "You are Owner!";
             show.setText(b);
           ...
           //String us = user_txt.getText();
            ResultSet existingUsername = dbcon.SEARCH("SELECT * FROM user WHERE `username` = '"+user+"' ");
            if(user.equals(existingUsername)){
                //JOptionPane.showMessageDialog(this,"This Username Used","ERROR!",JOptionPane.ERROR_MESSAGE);
            }
...
//           this.dispose();
    ...
    private void dob_txtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dob_txtMouseClicked
        // TODO add your handling code here:
        dob_txt.setText(null);
    }//GEN-LAST:event_dob_txtMouseClicked
