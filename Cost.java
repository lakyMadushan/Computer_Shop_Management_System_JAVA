...
//        AutoCompleteDecorator.decorate(expenCate_combo);
    ...
    private void initComponents() {
        ...
        loadAll1 = new javax.swing.JButton();
        ...
        jLabel5.setText("0");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 170, 90, 30));
        ...
        back_btn.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 204, 0), 4));
        ...
        cost_lbl.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        cost_lbl.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                cost_lblMouseClicked(evt);
            }
        });
        ...
        jPanel1.add(loadAll, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 140, 50, 40));

        loadAll1.setBackground(new java.awt.Color(255, 255, 255));
        loadAll1.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        loadAll1.setForeground(new java.awt.Color(255, 255, 255));
        loadAll1.setText("ALL");
        loadAll1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2));
        loadAll1.setContentAreaFilled(false);
        loadAll1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        loadAll1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                loadAll1ActionPerformed(evt);
            }
        });
        jPanel1.add(loadAll1, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 190, 50, 40));
    ...
    private void loadAll1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadAll1ActionPerformed
        // TODO add your handling code here:
        DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
        dtm.setRowCount(0);
        try {
    ...
    }//GEN-LAST:event_loadAll1ActionPerformed

    private void cost_lblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cost_lblMouseClicked
        // TODO add your handling code here:
        
    }//GEN-LAST:event_cost_lblMouseClicked
    ...
    private javax.swing.JButton loadAll1;
