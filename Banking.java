...
public class Banking extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        loadAll1Type = new javax.swing.JButton();
        ...
        search_txt.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        ...
        jPanel2.add(back_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 740, 190, 45));
        ...
        jPanel2.add(print_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 740, 190, 45));
        ...
        jPanel2.add(loadAll, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 150, 50, 40));

        loadAll1Type.setBackground(new java.awt.Color(255, 255, 255));
        loadAll1Type.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        loadAll1Type.setForeground(new java.awt.Color(255, 255, 255));
        loadAll1Type.setText("ALL");
        loadAll1Type.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2));
        loadAll1Type.setContentAreaFilled(false);
        loadAll1Type.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        loadAll1Type.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                loadAll1TypeActionPerformed(evt);
            }
        });
        jPanel2.add(loadAll1Type, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 210, 50, 40));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bank_1.png"))); // NOI18N
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 80, 300, 220));
    ...
    private void edit_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_edit_btnActionPerformed
        ...
        try {
            ...
            dbcon.IUD("UPDATE banking SET `date` = '"+date+"' WHERE `id` = '"+id+"' ");
            dbcon.IUD("UPDATE banking SET `category` = '"+category+"' WHERE `id` = '"+id+"' ");
            dbcon.IUD("UPDATE banking SET `type` = '"+type+"'WHERE `id` = '"+id+"'");
            dbcon.IUD("UPDATE banking SET `bank` = '"+bank+"'WHERE `id` = '"+id+"'");
            dbcon.IUD("UPDATE banking SET `distributor` = '"+dis+"'WHERE `id` = '"+id+"'");
            dbcon.IUD("UPDATE banking SET `customer` = '"+cus+"'WHERE `id` = '"+id+"'");
            dbcon.IUD("UPDATE banking SET `amount` = '"+amount+"'WHERE `id` = '"+id+"'");
    ...
    private void loadAll1TypeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadAll1TypeActionPerformed
        // TODO add your handling code here:
        DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
        dtm.setRowCount(0);
        try {
    ...
    }//GEN-LAST:event_loadAll1TypeActionPerformed
    ...
    private javax.swing.JButton loadAll1Type;
